...
Akira Diaryでは[checkBuild_Test_Swift.yml](https://github.com/FujimoriGit/AkiraDiary/blob/BR_develop-1.0/.github/workflows/checkBuild_Test_Swift.yml)でビルドとテストのチェックをPushまたはPull Requestを作成したときに実行されるようにしている。
